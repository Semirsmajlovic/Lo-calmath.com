	...
	<div class="eltdf-comment-holder clearfix" id="comments">
		<?php if ( have_comments() ) { ?>
			<div class="eltdf-comment-holder-inner">
				<h5 class="eltdf-comments-title"><?php esc_html_e( 'Comments', 'esmarts' ); ?></h5>
		...
		$eltdf_args = array(
			...
			'fields'               => apply_filters( 'esmarts_elated_filter_comment_form_default_fields', array(
				...
				'cookies' => '<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $eltd_consent . ' />' .
							'<label for="wp-comment-cookies-consent">' . esc_html__( 'Save my name, email, and website in this browser for the next time I comment.', 'esmarts' ) . '</label></p>',
            ) )
		);
