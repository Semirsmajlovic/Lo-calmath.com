...
class eSmartsElatedClassSimpleLineIcons implements ieSmartsElatedInterfaceIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'esmarts'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'esmarts'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'esmarts'),
            'icon-social-facebook'    => esc_html__('Facebook', 'esmarts'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'esmarts'),
            'icon-social-github'      => esc_html__('Github', 'esmarts'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'esmarts'),
            'icon-social-instagram'   => esc_html__('Instagram', 'esmarts'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'esmarts'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'esmarts'),
            'icon-social-reddit'      => esc_html__('Reddit', 'esmarts'),
            'icon-social-skype'       => esc_html__('Skype', 'esmarts'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'esmarts'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'esmarts'),
            'icon-social-spotify'     => esc_html__('Spotify', 'esmarts'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'esmarts'),
            'icon-social-twitter'     => esc_html__('Twitter', 'esmarts'),
            'icon-social-youtube'     => esc_html__('Youtube', 'esmarts')
        );
    }
