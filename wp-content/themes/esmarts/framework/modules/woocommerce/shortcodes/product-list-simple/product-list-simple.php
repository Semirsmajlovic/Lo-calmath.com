...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Elated Product List - Simple', 'esmarts' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'esmarts' )         => 'sale',
								esc_html__( 'Best Sellers', 'esmarts' ) => 'best-sellers',
								esc_html__( 'Featured', 'esmarts' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'esmarts' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order_by',
	...
	public function render( $atts, $content = null ) {
		...
		$html = esmarts_elated_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
