...
if ( ! function_exists( 'esmarts_elated_get_title_types_options' ) ) {
	function esmarts_elated_get_title_types_options() {
		$title_type_options = apply_filters( 'esmarts_elated_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'esmarts_elated_get_title_type_default_options' ) ) {
	function esmarts_elated_get_title_type_default_options() {
		$title_type_option = apply_filters( 'esmarts_elated_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('esmarts_elated_title_options_map') ) {
	function esmarts_elated_title_options_map() {
		$title_type_options        = esmarts_elated_get_title_types_options();
		$title_type_default_option = esmarts_elated_get_title_type_default_options();
		...
		$panel_title = esmarts_elated_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'esmarts')
			)
		);
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'esmarts' ),
				'parent'        => $panel_title,
				'args'          => array(
					'dependence'             => true,
			...
			$show_title_area_container = esmarts_elated_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				esmarts_elated_add_admin_field(
					...
					esmarts_elated_add_admin_field(
						array(
							'name'          => 'title_area_disable_parallax_image_responsive',
							'type'          => 'yesno',
							'default_value' => 'no',
					...
					esmarts_elated_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'esmarts' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'esmarts_elated_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = esmarts_elated_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = esmarts_elated_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'esmarts' ),
					'description' => esc_html__( 'Define styles for page title', 'esmarts' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = esmarts_elated_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = esmarts_elated_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = esmarts_elated_add_admin_row(
					array(
			...
			esmarts_elated_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'esmarts' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = esmarts_elated_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'esmarts' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'esmarts' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = esmarts_elated_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = esmarts_elated_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = esmarts_elated_add_admin_row(
					array(
		...
		do_action( 'esmarts_elated_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'esmarts_elated_action_options_map', 'esmarts_elated_title_options_map', 6);
}