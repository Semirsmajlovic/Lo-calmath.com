...
if ( ! function_exists( 'esmarts_elated_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function esmarts_elated_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'esmarts_elated_filter_blog_holder_classes', 'esmarts_elated_get_blog_holder_classes' );
}
