...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$menu_area_position                     = esmarts_elated_get_meta_field_intersect( 'set_menu_area_position', $page_id );
		...
		$parameters = apply_filters( 'esmarts_elated_filter_header_standard_parameters', $parameters );
