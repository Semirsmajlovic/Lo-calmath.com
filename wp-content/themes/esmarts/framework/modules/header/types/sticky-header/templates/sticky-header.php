<?php do_action('esmarts_elated_action_before_sticky_header'); ?>
...
<div class="eltdf-sticky-header">
            ...
            <div class=" eltdf-vertical-align-containers">
                ...
                <div class="eltdf-position-right">
                    <div class="eltdf-position-right-inner">
						<?php esmarts_elated_get_sticky_menu('eltdf-sticky-nav'); ?>
	...
	<?php do_action( 'esmarts_elated_action_before_sticky_menu_html_close' ); ?>
</div>
