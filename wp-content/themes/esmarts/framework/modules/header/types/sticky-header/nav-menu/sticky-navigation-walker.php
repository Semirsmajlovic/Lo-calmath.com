...
if (!class_exists('eSmartsElatedClassStickyNavigationWalker')) {
	class eSmartsElatedClassStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($depth==0){
				if($item->type_menu == "wide"){
					$menu_type = " wide";
				} else if( $item->type_menu == "wide-two-columns" ) {
					$menu_type = " wide wide-two-columns";
				} else {
					$menu_type = " narrow";
				}
			}
