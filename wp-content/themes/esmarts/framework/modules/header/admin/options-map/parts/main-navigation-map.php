...
if ( ! function_exists( 'esmarts_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function esmarts_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'esmarts_elated_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'esmarts_elated_header_main_navigation_options_map' ) ) {
	function esmarts_elated_header_main_navigation_options_map() {
		$hide_dep_options = esmarts_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = esmarts_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'esmarts' ),
		...
		esmarts_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'esmarts' )
			)
		);
		
		$drop_down_group = esmarts_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'esmarts' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'esmarts' )
			)
		);
		
		$drop_down_row1 = esmarts_elated_add_admin_row(
			array(
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'esmarts' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'esmarts' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'esmarts' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'esmarts' )
				)
			)
		);
		...
		$first_level_group = esmarts_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'esmarts' )
			)
		);
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'esmarts' ),
			)
		);
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'esmarts' ),
			)
		);
		
		$first_level_row4 = esmarts_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'esmarts' ),
			)
		);
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'esmarts' ),
			)
		);
		
		$first_level_row5 = esmarts_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = esmarts_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = esmarts_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'esmarts' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'esmarts' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = esmarts_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'esmarts' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'esmarts' )
			)
		);
		...
		esmarts_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'esmarts' )
			)
		);
		...
		$second_level_wide_group = esmarts_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'esmarts' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'esmarts' )
			)
		);
		
		$second_level_wide_row1 = esmarts_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = esmarts_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = esmarts_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = esmarts_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'esmarts' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'esmarts' )
			)
		);
		
		$third_level_row1 = esmarts_elated_add_admin_row(
			array(
		...
		$third_level_row2 = esmarts_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = esmarts_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = esmarts_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'esmarts' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'esmarts' )
			)
		);
		
		$third_level_wide_row1 = esmarts_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = esmarts_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = esmarts_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'esmarts_elated_action_header_main_navigation_options_map', 'esmarts_elated_header_main_navigation_options_map', 10, 1 );
}