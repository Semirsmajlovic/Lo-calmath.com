 ...
 */
if ( ! class_exists( 'eSmartsElatedClassSidebar' ) ) {
	class eSmartsElatedClassSidebar {
		var $sidebars = array();
		var $stored = "";
		...
		function __construct() {
			...
			$this->title  = esc_html__( 'Custom Widget Area', 'esmarts' );
		...
		function load_assets() {
			...
			wp_enqueue_script( 'esmarts-elated-sidebar', ELATED_ROOT . '/framework/admin/assets/js/eltdf-sidebar.js' );
			wp_enqueue_style( 'esmarts-elated-sidebar', ELATED_ROOT . '/framework/admin/assets/css/eltdf-sidebar.css' );
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'esmarts') . "' name='eltdf-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'esmarts') . "' />";
			echo "\n    " . $nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters( 'esmarts_elated_filter_custom_widget_args', $args );
