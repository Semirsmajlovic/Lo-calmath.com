...
class ElatedSkin extends eSmartsElatedClassSkinAbstract {
    /**
     * Skin constructor. Hooks to esmarts_elated_admin_scripts_init and esmarts_elated_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'elated';

        //hook to
        add_action('esmarts_elated_action_admin_scripts_init', array($this, 'registerStyles'));
        add_action('esmarts_elated_action_admin_scripts_init', array($this, 'registerScripts'));

        add_action('esmarts_elated_action_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('esmarts_elated_action_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('esmarts_elated_action_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('esmarts_elated_action_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
	        esmarts_elated_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
	        esmarts_elated_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    = esmarts_elated_get_admin_tab();
        $active_page = $theme_name_php_global_Framework->eltdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see eSmartsElatedClassSkinAbstract::loadTemplatePart()
     */
	 ...
	 *
	 * @param eSmartsElatedClassAdminPage $page current page to load
	 * @see eSmartsElatedClassSkinAbstract::loadTemplatePart()
	 */
